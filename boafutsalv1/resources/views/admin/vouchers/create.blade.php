    ...
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h1 class="text-2xl md:text-3xl font-extrabold text-white tracking-tight">
                Buat <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-emerald-400">Voucher Baru</span>
            </h1>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <input type="text" name="code" id="code" value="{{ old('code') }}"
                                       class="w-full bg-white/5 border {{ $errors->has('code') ? 'border-red-500/50' : 'border-white/10' }} rounded-xl px-4 py-3 text-white font-mono font-bold text-lg placeholder-gray-600 focus:outline-none focus:border-green-500/50 focus:bg-white/8 transition-all uppercase"
                                       placeholder="CONTOH25" maxlength="20"
                                       oninput="this.value = this.value.toUpperCase()">
                                <div class="absolute right-3 top-1/2 -translate-y-1/2">
                                    <button type="button" onclick="generateCode()"
                                            class="text-xs px-2.5 py-1 bg-green-500/20 text-green-400 rounded-lg font-bold hover:bg-green-500/30 transition-all">
                                        Generate
                                    </button>
                                </div>
                            </div>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}"
                                   class="w-full bg-white/5 border {{ $errors->has('name') ? 'border-red-500/50' : 'border-white/10' }} rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 focus:bg-white/8 transition-all"
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="3"
                                      class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 focus:bg-white/8 transition-all resize-none"
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="discount_value" value="{{ old('discount_value') }}"
                                           class="w-full bg-white/5 border {{ $errors->has('discount_value') ? 'border-red-500/50' : 'border-white/10' }} rounded-xl pl-8 pr-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 transition-all"
                            ...
                            <div id="maxDiscountField">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="number" name="max_discount" value="{{ old('max_discount') }}"
                                           class="w-full bg-white/5 border border-white/10 rounded-xl pl-9 pr-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 transition-all"
                                           placeholder="0" min="0">
                                </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_from" value="{{ old('valid_from') }}"
                                       class="w-full bg-white/5 border {{ $errors->has('valid_from') ? 'border-red-500/50' : 'border-white/10' }} rounded-xl px-4 py-3 text-white focus:outline-none focus:border-green-500/50 transition-all [color-scheme:dark]">
                                @error('valid_from')
                                    <p class="mt-1.5 text-xs text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="date" name="valid_until" value="{{ old('valid_until') }}"
                                       class="w-full bg-white/5 border {{ $errors->has('valid_until') ? 'border-red-500/50' : 'border-white/10' }} rounded-xl px-4 py-3 text-white focus:outline-none focus:border-green-500/50 transition-all [color-scheme:dark]">
                                @error('valid_until')
                                    <p class="mt-1.5 text-xs text-red-400 font-medium">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                ...
                                <input type="number" name="usage_limit" value="{{ old('usage_limit') }}"
                                       class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:border-green-500/50 transition-all"
            ...
            <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-7 gap-1.5">
                                ...
                                <label class="cursor-pointer">
                                    ...
                                    <div class="peer-checked:bg-green-500/20 peer-checked:border-green-500/50 peer-checked:text-green-400 text-center py-2 rounded-lg border border-white/10 text-gray-500 text-[10px] font-bold hover:border-white/20 transition-all text-xs">
                                        {{ $day }}
                                    </div>
                                </label>
                                @endforeach
                ...
                <div class="bg-white/5 border border-white/10 rounded-3xl p-6 md:p-8 backdrop-blur-xl shadow-2xl">
                    ...
                    <div class="relative overflow-hidden rounded-2xl bg-gradient-to-br from-green-600/30 via-emerald-600/20 to-green-600/10 border border-green-500/30 p-5">
                        <div class="absolute top-0 right-0 w-24 h-24 rounded-full bg-green-500/10 -translate-y-8 translate-x-8"></div>
                        <div class="absolute bottom-0 left-0 w-16 h-16 rounded-full bg-emerald-500/10 translate-y-6 -translate-x-6"></div>

                        <div class="relative">
                            <div class="flex items-start justify-between mb-4">
                                <div>
                                    <p class="text-xs font-bold text-green-300 uppercase tracking-widest mb-1">BOA FUTSAL</p>
                            ...
                            <div class="mb-4">
                                ...
                                <p class="text-green-300 text-xs font-bold mt-0.5">DISKON</p>
                            </div>

                            <div class="border-t border-white/10 pt-3 flex items-center justify-between">
                                <div>
                                    <p class="text-xs text-green-300 font-bold mb-0.5">KODE</p>
                                    <p id="previewCode" class="text-base font-extrabold text-white font-mono tracking-widest">-</p>
                                </div>
                                <div class="text-right">
                                    <p class="text-xs text-green-300 font-bold mb-0.5">BERLAKU S/D</p>
                ...
                <!-- Submit Button -->
                <button type="submit"
                        class="w-full py-4 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-400 hover:to-emerald-400 text-white font-extrabold text-base rounded-2xl transition-all duration-300 shadow-lg hover:shadow-green-500/30 hover:-translate-y-0.5 flex items-center justify-center gap-2">
