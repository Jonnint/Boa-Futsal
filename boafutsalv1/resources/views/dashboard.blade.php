            ...
            <div class="relative overflow-hidden rounded-2xl md:rounded-[2rem] p-6 md:p-12 bg-gradient-to-br from-green-500/10 via-green-600/5 to-transparent border border-green-500/20 mb-6 md:mb-8">
                ...
                <div class="relative z-10">
                    ...
                    <p class="text-gray-400 text-base md:text-lg lg:text-xl max-w-2xl">
                        Selamat datang di dashboard Member BOA Futsal. Nikmati kemudahan booking dan diskon eksklusif khusus untuk Anda.
                    </p>
                </div>
            </div>
            ...
            <div class="mb-6 md:mb-8 rounded-[1.5rem] bg-gradient-to-r from-green-600/20 to-green-900/10 border border-green-500/20 p-6 flex flex-col md:flex-row items-center justify-between gap-6 glow-green relative overflow-hidden">
                ...
                <div class="flex flex-row gap-6 w-full md:w-auto bg-black/30 p-4 rounded-xl border border-white/5 relative z-10">
                    <div>
                        ...
                        <p class="font-bold text-white text-lg">{{ now()->addYear()->format('d M Y') }}</p>
                    </div>
