        ...
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="relative overflow-hidden rounded-[2rem] p-8 md:p-12 bg-gradient-to-br from-green-500/10 via-green-600/5 to-transparent border border-green-500/20 mb-8">
                ...
                <div class="relative z-10">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-green-500/10 border border-green-500/20 text-green-400 text-xs font-bold uppercase tracking-widest mb-4">
            ...
            <div class="grid md:grid-cols-3 gap-6 mb-8">
                <div class="group relative overflow-hidden rounded-[1.5rem] bg-white/5 border border-white/10 p-6 hover:border-green-500/30 transition-all duration-500">
                ...
                <div class="group relative overflow-hidden rounded-[1.5rem] bg-white/5 border border-white/10 p-6 hover:border-yellow-500/30 transition-all duration-500">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-extrabold text-white mb-1">{{ $stats['active_bookings'] }}</h3>
                        <p class="text-sm text-gray-400">Booking Aktif</p>
                    </div>
                </div>

                <div class="group relative overflow-hidden rounded-[1.5rem] bg-white/5 border border-white/10 p-6 hover:border-blue-500/30 transition-all duration-500">
                    ...
                    <div class="relative">
                        ...
                        <h3 class="text-3xl font-extrabold text-white mb-1">Rp {{ number_format($stats['total_spent'], 0, ',', '.') }}</h3>
            ...
            <div>
                <div class="flex items-center gap-3 mb-6">
                    <h2 class="text-2xl font-extrabold tracking-tight">Quick Actions</h2>
                    <div class="flex-1 h-px bg-gradient-to-r from-white/10 to-transparent"></div>
                </div>
                
                <div class="grid md:grid-cols-3 gap-6">
                    <a href="/" class="group relative overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-green-500 to-green-600 p-8 hover:scale-[1.02] transition-all duration-300 glow-green">
                        <div class="absolute top-0 right-0 w-32 h-32 bg-white/10 rounded-full blur-2xl"></div>
                        <div class="relative">
                            <div class="w-14 h-14 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                                <svg class="w-7 h-7 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6"></path>
                                </svg>
                            </div>
                            <h3 class="text-xl font-bold text-white mb-2">Booking Baru</h3>
                            <p class="text-green-50 text-sm">Pesan lapangan sekarang juga</p>
                        </div>
                    </a>

                    <a href="{{ route('bookings.index') }}" class="group relative overflow-hidden rounded-[1.5rem] bg-white/5 border border-white/10 p-8 hover:border-white/20 hover:bg-white/[0.07] transition-all duration-300">
                        <div class="w-14 h-14 bg-blue-500/10 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
                            <svg class="w-7 h-7 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path>
                            </svg>
                        </div>
                        <h3 class="text-xl font-bold text-white mb-2">Riwayat Booking</h3>
                        <p class="text-gray-400 text-sm">Lihat semua booking kamu</p>
                    </a>

                    <a href="{{ route('profile.edit') }}" class="group relative overflow-hidden rounded-[1.5rem] bg-white/5 border border-white/10 p-8 hover:border-white/20 hover:bg-white/[0.07] transition-all duration-300">
                        <div class="w-14 h-14 bg-purple-500/10 rounded-2xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
